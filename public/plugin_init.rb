...
require File.join(__dir__, 'helpers', 'tufts_public_view_helper_override.rb')

Rails.application.config.to_prepare do
  require_dependency 'view_helper'

  unless ViewHelper.ancestors.include?(TuftsPublicViewHelperOverride)
    ViewHelper.prepend(TuftsPublicViewHelperOverride)
  end
end
class ArchivesSpaceClientPublic
