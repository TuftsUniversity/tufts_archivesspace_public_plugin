class SearchController < ApplicationController
  ...
  DEFAULT_SEARCH_OPTS = {
#    'sort' => 'title_sort asc',
    'resolve[]' => ['resource:id@compact_resource', 'ancestors:id@compact_resource', 'top_container_uri_u_sstr:id'],
    'facet.mincount' => 1
  }
  DEFAULT_TYPES = %w{archival_object digital_object agent resource accession classification subject}
